...
def test_image_goes_directly_to_ocr(monkeypatch):
    ...
    monkeypatch.setattr("app.core.pipeline.bol_extract.extract_text_from_file_ocr", fake_ocr)
...
def test_pdf_falls_back_to_ocr(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("app.core.pipeline.bol_extract.extract_text_from_pdf", fake_pdf_text)
    monkeypatch.setattr("app.core.pipeline.bol_extract.extract_text_from_file_ocr", fake_ocr)
